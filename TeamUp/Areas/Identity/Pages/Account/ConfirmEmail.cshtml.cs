...
namespace TeamUp.Areas.Identity.Pages.Account
{
    ...
    public class ConfirmEmailModel : PageModel
    {
        ...
        public ConfirmEmailModel(UserManager<TeamUpUser> userManager)
        {
        ...
        public async Task<IActionResult> OnGetAsync(string userId, string code)
        {
            ...
            StatusMessage = result.Succeeded ? "Adres email został potwierdzony." : "Wystąpił błąd podczas potwierdzania adresu email.";
            return Page();
        }
    }
}
