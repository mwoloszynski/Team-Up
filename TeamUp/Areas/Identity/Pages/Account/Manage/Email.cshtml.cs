    ...
    public partial class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _emailSender.SendEmailAsync(new Models.EmailConfig.Message(new string[] { Input.NewEmail }, "Email Verification", callbackUrl));
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            await _emailSender.SendEmailAsync(new Models.EmailConfig.Message(new string[] { email }, "Email Verification", callbackUrl));
