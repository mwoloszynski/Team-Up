...
namespace TeamUp.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            {
                var user = new TeamUpUser { UserName = Input.Email, Email = Input.Email };
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        await _emailSender.SendEmailAsync(new Models.EmailConfig.Message(new string[] { Input.Email }, "Email Verification", callbackUrl));
